...
import ClientStackPng from '@site/static/prysm/docs/img/client-stack.png';
import NetworkPng from '@site/static/prysm/docs/img/network.png';
import NetworkLayersPng from '@site/static/prysm/docs/img/network-layers.png';
